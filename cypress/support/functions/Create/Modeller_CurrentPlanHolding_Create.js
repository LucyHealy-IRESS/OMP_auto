import * as moCurrentPlanConstants from "../../constants/modeller_CurrentPlans.js"
import * as Constants from "../../constants/Core.js";


Cypress.Commands.add("Modeller_CurrentPlanHolding_Create_1", (EntityData) => {
    cy.clickAccordion_PreCheck(".holdings", moCurrentPlanConstants.CurrentPlanEditorSelector, "Holdings")
    cy.wait(2000)
    cy.clickButtonInPopup(moCurrentPlanConstants.CurrentPlanEditorSelector, "Pick funds from shortlist using fund name or ISIN");
...
Cypress.Commands.add("Modeller_CurrentPlanHolding_Create_2", (EntityData) => { });

Cypress.Commands.add("Modeller_CurrentPlanHolding_Create_3", (EntityData) => { });

Cypress.Commands.add("Modeller_CurrentPlanHolding_Tidy", (EntityData) => {
