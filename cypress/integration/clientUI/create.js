...
describe("new test", () => {
   it("Create Client via XML", () =>{
      ...
      cy.get('#EditClientPopup .client_info_table',{ timeout: 226000 }).then(function () { //ensure client editor is there and client info section has loaded
      ...
      cy.readFile(fileLocation).then(function (fileContents) {
         ...
         var CreateClientCallback = function(Client){
            ...
            cy.CreateClient_UI(Client, clientMapping.ClientInputs);
            cy.reload();
            cy.login('uat', 'username2', 'password2');
            ...
            cy.get('#EditClientPopup .client_info_table').then(function () { //ensure client editor is there and client info section has loaded
               cy.AssertingClient_UI(Client, clientMapping.ClientInputs);
            })
